...
patch2: policy-rhel-alt-7.4-base.patch
patch3: policy-rhel-alt-7.4-contrib.patch
...
%changelog
* Wed Sep 20 2017 Lukas Vrabec  <lvrabec@redhat.com> - 3.13.1-172
- Allow sysctl_irq_t assciate with proc_t
Resolves: rhbz#1483550
